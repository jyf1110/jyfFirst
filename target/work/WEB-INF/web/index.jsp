...
<head>
    ...
    <!-- css files -->
    <link rel="stylesheet" href="<%=path%>/static/css/style.css" type="text/css" media="all" /> <!-- Style-CSS -->
    <link rel="stylesheet" href="<%=path%>/static/css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
    <!-- //css files -->

    <!-- js -->
    <script src="<%=path%>/static/js/jquery-3.3.1.min.js"></script>    <!-- //js -->
...
<body>
<script src="<%=path%>/static/js/jquery.vide.min.js"></script>
<!-- main -->
